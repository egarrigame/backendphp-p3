        ...
        <div class="max-w-lg mx-auto px-4">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-base font-medium text-gray-900">Datos del técnico</h3>
                    <p class="text-sm text-gray-500 mt-0.5">Rellena los campos para dar de alta un nuevo técnico.</p>
                </div>
                    ...
                    <form action="{{ route('admin.tecnicos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                required
                                placeholder="tecnico@reparaya.com">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select name="especialidad_id" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white" required>
                        ...
                        <div class="flex justify-end items-center gap-3 pt-5 border-t border-gray-100">
                            <a href="{{ route('admin.tecnicos.index') }}"
